# Infrastructure funding statement pages
...
These pages are [updated nightly](https://github.com/digital-land/infrastructure-funding-statement/actions) by the [GitHub Action](.github/workflows/run.yml).
